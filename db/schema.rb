...
ActiveRecord::Schema.define(version: 20160109025552) do
  ...
  add_index "swattr_projects", ["slug"], name: "index_swattr_projects_on_slug", unique: true
  ...
  add_index "swattr_tags", ["slug"], name: "index_swattr_tags_on_slug", unique: true
